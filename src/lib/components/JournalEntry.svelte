...
<Card class="mb-8 rounded-xl overflow-hidden shadow-lg">
  {#if layout === "single-with-mood" && images.length > 0}
    <div class="grid grid-cols-2 gap-1">
      <div class="h-[150px] relative">
        <img src={images[0].src || "/placeholder.svg"} alt={images[0].alt} class="object-cover" />
      </div>
      {#if mood}
        <div class="h-[150px] bg-[#e0f0d0] flex flex-col items-center justify-center p-4">
          <div class="relative w-20 h-20">
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                ...
                opacity="0.7"
              />
              <path d="M50 40 L54 46 L60 50 L54 54 L50 60 L46 54 L40 50 L46 46 Z" fill={mood.color} opacity="0.9" />
      ...
      {#if images.length >= 3}
        ...
        <div class="grid grid-rows-2 gap-1">
          <div class="h-[100px] relative">
            <img src={images[1].src || "/placeholder.svg"} alt={images[1].alt} class="object-cover" />
          </div>
          <div class="h-[100px] relative">
            <img src={images[2].src || "/placeholder.svg"} alt={images[2].alt} class="object-cover" />
          </div>
        </div>
      {/if}
    </div>
